...
const int SQOpPool::get_nsaop() const { return nsaop_; }
                ...
                if (!find_irrep(orb_irreps_to_int_, std::vector<size_t>{ia, ia, aa, aa})) {
                    ...
                    if (temp2.terms().size() > 0) {
                        std::vector<size_t> vtemp{
                            std::get<1>(temp2.terms()[0])[0], std::get<1>(temp2.terms()[0])[1],
                            std::get<2>(temp2.terms()[0])[0], std::get<2>(temp2.terms()[0])[1]};
                        std::vector<size_t> vadjt{
                            std::get<1>(temp2.terms()[1])[0], std::get<1>(temp2.terms()[1])[1],
                            std::get<2>(temp2.terms()[1])[0], std::get<2>(temp2.terms()[1])[1]};
                            ...
                            if ((aa != ba) && (ia != ja)) {
                                ...
                                if (temp2aaaa.terms().size() > 0) {
                                    ...
                                    if ((std::find(uniqe_2bdy.begin(), uniqe_2bdy.end(), vtemp) ==
                                        ...
                                        if ((std::find(adjnt_2bdy.begin(), adjnt_2bdy.end(),
                                                       vtemp) == adjnt_2bdy.end())) {
                                            if ((std::find(sa_uniqe_2bdy.begin(),
                                                           sa_uniqe_2bdy.end(),
                                                           vtemp) == sa_uniqe_2bdy.end())) {
                                                if ((std::find(sa_adjnt_2bdy.begin(),
                                                               sa_adjnt_2bdy.end(),
                                                               vtemp) == sa_adjnt_2bdy.end())) {
                                                    uniqe_2bdy.push_back(vtemp);
                                                    adjnt_2bdy.push_back(vadjt);
                                                    add_term(1.0, temp2aaaa);
                                                }
